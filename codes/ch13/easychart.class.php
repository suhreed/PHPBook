  ...
  */ 
  ...
  { 
    ...
    { 
      ...
      @ImageString ($im, 1, 0, $this->height - 10, "This bar graph is dynamically created by PHP", $black); 
      ...
      echo "<img src=\"$im\" alt=\"Bar Chart Created by PHP\">";
      @ImageDestroy($im);  
    } 
  }; 
