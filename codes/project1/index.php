...
//select posts
$sql = "SELECT p.id, p.title AS title, p.text as text, p.created as created, a.id AS authorID, a.fname AS firstname, a.lname AS lastname 
        FROM posts p, authors a 
        WHERE p.author_id = a.id AND p.status = 1 
